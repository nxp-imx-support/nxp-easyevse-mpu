...
class Get:  # pylint: disable=too-few-public-methods
    ...
    def get_key(self, key_id, file_name=None, encode_format=""):
        ...
        if ((self.ctx_key.keyobject.cipherType == apis.kSSS_CipherType_Binary) and (encode_format != "HEX")) :
            self.ctx_key.keyobject.cipherType = apis.kSSS_CipherType_Certificate
