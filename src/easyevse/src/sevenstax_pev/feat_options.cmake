...
option(FEATPROD_ICMP_SUPPORTED "Enables ICMP-Ping responses" ON)
...
option(FEATPROD_TCP_SOCKET_SUPPORTED "Enables TCP Service module." ON)
...
option(FEATPROD_HTTP_SUPPORTED "Enables HTTP generator & parser" OFF)
option(FEATPROD_HTTPCLNT_SUPPORTED "Enables HTTP client" OFF)
...
option(FEATPROD_JSONGEN_SUPPORTED "Enables JSON Generator module" OFF)
option(FEATPROD_JSONPRS_SUPPORTED "Enables JSON Parser module" OFF)
...
option(FEATPROD_SESSION_SUPPORTED "Enables session module" OFF)
option(FEATPROD_JWT_SUPPORTED "Enables JWT module" OFF)

option(FEATPROD_PARSESTR_SUPPORTED "parse string module support" ON)
option(FEATPROD_PRINTSTR_SUPPORTED "print string module support" ON)
option(FEATPROD_DATACONVERTER_SUPPORTED "dataconverter support" ON)
...
option(FEATPROD_UNIXFS_SUPPORTED "Enables Unix STX-Filesystem Interface (Dir2Flash)" ON)
...
option(FEATPROD_TLSSERV_SUPPORTED "Enables TLS server." OFF)
option(FEATPROD_TLSCLNT_SUPPORTED "Enables TLS client." ON)
option(FEATPROD_TLS13_SERV_SUPPORTED "Enables TLS server." OFF)
option(FEATPROD_TLS13_CLNT_SUPPORTED "Enables TLS client." ON)
option(FEATPROD_X509PARSER_SUPPORTED "Enables X509 (X.509 Certificates)" ON)
option(FEATPROD_X509REQUEST_SUPPORTED "Enables Certificate Renewal Helper." OFF)
option(FEATPROD_X509MNGR_SUPPORTED "Enables Certificate Manager module." ON)
option(FEATPROD_OCSP_SUPPORTED "Enables OCSP." OFF)
...
option(FEATPROD_SHA3_SUPPORTED "Enables SHA3 (Secure Hash Algorithm 3)" OFF)
...
option(FEATPROD_CHACHA20_SUPPORTED "Enables ChaCha20 stream cipher module." ON)

#/* ENCRYPT - Stream cipher modes */
option(FEATPROD_POLY1305_SUPPORTED "Enables Poly1305 AEAD mode." ON)

#/* ENCRYPT - Asymmetric cryptography. */
option(FEATPROD_RSA_SUPPORTED "Enables RSA (public key cryptography) module" OFF)
option(FEATPROD_DH_SUPPORTED "Enables DH (diffie hellman key exchange) module" OFF)
...
option(FEATPROD_RSASSA_PSS_SUPPORTED "Enables RSASSA_PSS signature scheme module" OFF)
...
option(FEATPROD_HSM_SUPPORTED "Enable HSM module" ON)
option(FEATPROD_TEST_HSM_SUPPORTED "Enable HSM test driver using signature service" OFF)
...
option(FEATPROD_CRYPTGCM_SUPPORTED "Enables GCM (Galois/Counter mode) module" ON)
...
option(FEATPROD_V2G_CP_SUPPORTED "Enables sevenstax V2G CP services module" ON)

#/* V2G Mode */
option(FEATPROD_V2G_PNC_SUPPORTED "Enables V2G PNC" ON)
option(FEATPROD_V2G_EVSE_SUPPORTED "Enables Electric Vehicle Supply Equipment (EVSE)" OFF)
option(FEATPROD_V2G_EV_SUPPORTED "Enables Electric Vehicle (EV)" ON)
option(FEATPROD_V2G_DIN_SUPPORTED "Enables DIN70121-2:2012 protocol" OFF)
...
option(FEATPROD_V2G_ISO20_SUPPORTED "Enables ISO15118-20:2020 protocol" ON)
option(FEATPROD_V2G_PNC_SUPPORTED "Enables Plug'n'Charge" ON)
option(FEATPROD_V2G_COM_SERVICE "Enables Communication service module" ON)

#/* V2G Message Handler */
option(FEATPROD_V2G_MSG_HANDLER_DIN "Enables message handler for DIN70121-2:2012" OFF)
option(FEATPROD_V2G_MSG_HANDLER_ISO "Enables message handler for ISO15118-2:2014" ON)
option(FEATPROD_V2G_MSG_HANDLER_ISO20 "Enables message handler for ISO15118-20:2020" ON)

#/* SECC */
option(FEATPROD_SECCDPS_SUPPORTED "SECC Discovery Protocol for EVSE" OFF)
option(FEATPROD_SECCDP_SUPPORTED "SECC Discovery Protocol for EV" ON)
...
option(FEATPROD_SLAC_MODE_EV_SUPPORTED     "enables EV mode for SLAC" ON )
option(FEATPROD_SLAC_MODE_EVSE_SUPPORTED     "enables EVSE mode for SLAC" OFF )
...
option(FEATPROD_PWM_SUPPORTED "Enables sevenstax PWM driver" ON)
option(FEATPROD_ADC_SUPPORTED "Enables sevenstax ADC driver" ON)
...
option(FEATPROD_MTP_SUPPORTED "Activate when when mtp dbg, mtp cntrl or mtp framing are enabled. " OFF)
