...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_style_text_font(ui->screen_label_44, &lv_font_arial_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_label_54, &lv_font_arial_18, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_label_56, 2, 447);
